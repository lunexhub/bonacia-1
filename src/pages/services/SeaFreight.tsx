...
import { Ship, Container, Globe, Clock, CheckCircle, ArrowRight, Phone } from "lucide-react";
import { Button } from "@/components/ui/button";
import Layout from "@/components/layout/Layout";
import heroImage from "@/assets/service-sea.jpg";

const features = [
  {
    icon: Container,
    title: "All Container Types",
    description: "High cube, standard 40ft & 20ft, RORO, and open containers available",
  },
  {
    icon: Globe,
    title: "Global Ports",
    description: "Access to major shipping lines and ports worldwide",
  },
  {
    icon: Clock,
    title: "Consolidation Services",
    description: "Groupage options for small volume shipments",
  },
];

const benefits = [
  "High cube and standard 40ft & 20ft containers",
  "RORO and open container options",
  "Consolidation and groupage services",
  "Heavy equipment and machinery transport",
  "Quick customs documentation processing",
        ...
        <div className="container-wide relative z-10 py-16 sm:py-20 md:py-24 lg:py-28 xl:py-32 px-4 sm:px-6">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/20 text-accent mb-5 sm:mb-6">
              ...
              <span className="text-xs sm:text-sm font-medium">Sea Freight Services</span>
            </div>
            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-5 sm:mb-6 md:mb-8 leading-tight">
              Reliable <span className="text-accent">Sea Freight</span> Worldwide
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-white/90 mb-6 sm:mb-8 max-w-2xl leading-relaxed">
              You can always count on us to deliver your goods. Our team of experts secures space in various vessels to different ports of destination worldwide.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 md:gap-16 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 sm:mb-8 text-base sm:text-lg">
                BH Sea freight exports and imports team of experts together with our time-tested partners across the globe secure space in various vessels to different ports of destination.
              </p>
              <p className="text-muted-foreground mb-6 sm:mb-8 text-base sm:text-lg">
                No matter the size of your shipments, we at Bonacia Holdings have tailor-made solutions to meet your sea freight needs. Our workforce has the requisite skills and knowhow to move your heavy equipment and machinery.
              </p>
            ...
            >
              ...
              <p className="text-white/80 text-sm sm:text-base mb-6 sm:mb-8">
                Get competitive rates for FCL and LCL shipments. Our team will find the best solution for your cargo requirements.
              </p>
